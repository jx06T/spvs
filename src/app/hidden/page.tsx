    ...
    if (!session) {
        return (
            <div className=' w-full px-2'>
                ...
                <Link className='text-lg bg-gray-400 px-4 py-3 rounded-xl block w-30 mt-6' href="/?auto=1">回去吧<FaceWhitOpenMouth className=' inline-block ml-3 text-xl -mt-0.5' /></Link>
            </div>
        );
    }
